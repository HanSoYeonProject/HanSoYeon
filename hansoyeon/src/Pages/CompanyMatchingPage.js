...
const CompanyMatchingPage = () => {
    ...
    const handleCheckApplicants = async (announcement) => {
        setSelectedAnnouncement(announcement); // Save the entire announcement object
        setSelectedJobId(announcement.job_id); // This might still be needed for other operations
