...
public class WebSecurityConfig {
    ...
    protected SecurityFilterChain configure(HttpSecurity httpSecurity) throws Exception{
        httpSecurity
                ...
                .authorizeRequests()
                .antMatchers("/", "/api/auth/**", "/api/createAnnouncement","/api/announcements/**", "api/reviews" , "/api/reviews/**", "/api/recruits/**", "/api/uploadProfileImage", "/api/cos/**", "/api/sms/**", "/api/schedulers","/api/recruitments","/api/createRecruitment","/api/recruitments/**").permitAll()
